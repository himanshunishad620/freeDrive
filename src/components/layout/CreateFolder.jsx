...
export default function CreateFolder({ handleCreateFolderToggle }) {
  return (
    <div className="fixed top-0 left-0 z-30 flex h-full w-full items-center justify-center bg-black/40">
      <form className="relative flex w-90 flex-col items-center gap-2 bg-white px-10 py-5 md:w-100">
