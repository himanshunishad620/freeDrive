      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        ...
        <div className="mb-20 flex flex-col items-center gap-12 md:flex-row">
          ...
          <div className="w-full md:w-2/3">
            ...
            <p className="mb-6 text-lg text-gray-600">
              A [your profession] passionate about digital privacy and
        ...
        <section className="rounded-xl bg-blue-600 p-10 text-center text-white">
          <h2 className="mb-4 text-2xl font-bold">
            Ready to experience truly free storage?
          </h2>
          <p className="mx-auto mb-6 max-w-2xl text-blue-100">
            Join thousands of users who've taken control of their cloud storage
          </p>
